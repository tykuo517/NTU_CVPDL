...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "train": (root / "train_aug_by_text", root / "train_aug_by_text" / 'train.json'),
        "train_reg": (root / "train_aug_by_text", root / "train_aug_by_text" / 'train.json'),
        "val": (root / "valid", root / "valid" / 'valid.json'),
        "eval_debug": (root / "valid", root / "valid" / 'valid.json'),
        "test": (root / "test", root / "annotations" / 'image_info_test-dev2017.json' ),
    }
